...
tmp_dir=/home/karlwenn/scratch/asegstats_tmp
...
for fs_file in "$ses_BL_root"/*; do
    ...
    if [[ $j -ne 5 && $i -eq 400 ]]; then # Running 400 subject at a time, except on last subjects. Check j first in conjunction for minor speed increase. Can get mats for minor speed increase on the AH, as well. 
        ...
        asegstats2table --subjectsfile="../data/ses-BL_subjects.txt" --meas=volume --tablefile="../data/ses-BL_asegstats_$j.txt" -d comma --skip
...
asegstats2table --subjectsfile="../data/ses-V04_subjects.txt" --meas=volume --tablefile="../data/ses-V04_asegstats.txt" -d comma --skip
...
asegstats2table --subjectsfile="../data/ses-V06_subjects.txt" --meas=volume --tablefile="../data/ses-V06_asegstats.txt" -d comma --skip
...
asegstats2table --subjectsfile="../data/ses-V08_subjects.txt" --meas=volume --tablefile="../data/ses-V08_asegstats.txt" -d comma --skip
...
asegstats2table --subjectsfile="../data/ses-V10_subjects.txt" --meas=volume --tablefile="../data/ses-V10_asegstats.txt" -d comma --skip
